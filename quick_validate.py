...
REQUIRED_FILES = [
    ...
    "templates/.harness/agents/tdd_lead.md",
    "templates/.harness/agents/red_test_author.md",
    "templates/.harness/agents/green_implementer.md",
    "templates/.harness/agents/refactor_specialist.md",
    "templates/.harness/agents/architecture_lead.md",
    "templates/.harness/agents/blueprint_architect.md",
    "templates/.harness/agents/context_auditor.md",
    "templates/.harness/agents/business_rule_auditor.md",
    "templates/.harness/agents/code_quality_auditor.md",
    "templates/.harness/agents/test_verifier.md",
    "templates/.harness/agents/confidence_reporter.md",
    "templates/.harness/rules/data_storage.md",
